...
import com.zdy.mystarter.intergration.mapper.basic.AnnotationCacheBasicMapper;
...
public class BasicController {
    ...
    @Resource
    AnnotationCacheBasicMapper annotationCacheBasicMapper;
    ...
    public List<StudentVo> qryAllStudentVoList(@PathVariable("url") String urlParam,
        ...
        if(!StringUtils.isEmpty(urlParam)){
            switch(urlParam){
                case "1":stList=annotationCacheBasicMapper.qryAllStudentVoList(studentVo);break;
    ...
    public List<TeacherVo> qryAllTeacherVoList(@PathVariable("url") String urlParam,
        ...
        try{
            ...
            if(!Objects.isNull(urlParam)){
                switch(urlParam){
                    case "1": stList=annotationCacheBasicMapper.qryAllTeacherVoList(teacherVo);break;
