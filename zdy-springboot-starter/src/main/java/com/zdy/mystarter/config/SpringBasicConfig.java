...
import com.zdy.mystarter.basic.msgconverters.http.SpecializationHttpMessageConvert;
...
public class SpringBasicConfig implements WebMvcConfigurer {
    ...
    public void extendMessageConverters(List<HttpMessageConverter<?>> converters) {
         ...
         * 重新定制一个消息转换器
         */
        SpecializationHttpMessageConvert specializationHttpMessageConvert=new SpecializationHttpMessageConvert();
        //todo 配置特性
        //converters.add(specializationHttpMessageConvert);
